var ClarityGraph = function(siyuan2) {
...
var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" : key, value);
  ...
  class ClarityGraphPlugin extends siyuan2.Plugin {
    constructor() {
      super(...arguments);
    ...
    async refresh() {
      ...
      try {
        ...
        console.error(error);
        siyuan2.showMessage("Clarity Graph failed to load global references");
    ...
    draw() {
      ...
      for (const node of nodes) {
        ...
        circle.addEventListener("click", () => {
          void siyuan2.openTab({ app: this.app, doc: { id: node.id } });
        });
